...
- Values being displayed incorrectly when accessing Leaf details

## [1.11.0] - 2023-02-14

### Changed

- Update Logos to reflect Umbrella's new visual identity
- Filter out FCD flagged as inactive
- Use Goerli as dev network for Arbitrum

## [1.10.0] - 2022-12-14

### Changed

- Remove Proof, Key (Bytes) and Value (Bytes) columns from Datapairs table
- Add Age column to Dtapairs table
- Enforce network environment variables for BSC on all deployment workflows

## [1.9.0] - 2022-11-04

### Changed

- Switch Eth dev network to Goerli
- Switch Eth sbx network to Goerli
- Extracted texts to i18n files

## [1.8.2] - 2022-06-22

### Changed

- Latest block fetching logic
...
- Internal URLs handling for blocks details
...
- Code refactor
- Extract API calls to store layer
- Update LICENSE
...
- Block URL to datapairs table

## [1.7.1] - 2022-04-10

### Fixed

- Solana URLs for Datapairs table when using testnets
...
- Support Solana
- Makefile and github actions to deploy Solana

## [1.6.1] - 2022-02-25

### Changed

- Update Umbrella SDK version
- Add Babel presets to fix code compatibility
